package imale.blogapirest.Configuration;
...
public class JwtService {
    ...
    public <T> T getAClaim(String token, Function<Claims, T> claimsResolver){
    ...
    public boolean isTokenExpired(String token){
        Date expiration = getAClaim(token, Claims::getExpiration);
